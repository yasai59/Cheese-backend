    ...
    test("Obtener los gustos de una persona", async () => {
        try {
            const res = await axios.get("/api/taste", {
                headers: {
                    "x-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFsZXh2aWRhbGNhc2Fkb0BnbWFpbC5jb20iLCJpYXQiOjE3MTI2NTI2Mzh9.cFsTxcOB2Y8kli-e6XpW6WsB41EmVTt6rkr_9OZBPrA",
                },
            });
